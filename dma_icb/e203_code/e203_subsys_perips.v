...
module e203_subsys_perips(
  ...
  output                     dma_cfg_icb_cmd_valid,
  input                      dma_cfg_icb_cmd_ready,
  output                     dma_cfg_icb_cmd_read,
  output [32-1:0]            dma_cfg_icb_cmd_addr,
  output [32-1:0]            dma_cfg_icb_cmd_wdata,
  output [3:0]               dma_cfg_icb_cmd_wmask,

  input                      dma_cfg_icb_rsp_valid,
  output                     dma_cfg_icb_rsp_ready,
  input  [32-1:0]            dma_cfg_icb_rsp_rdata,
  input                      dma_cfg_icb_rsp_err,
  ...
  //  * GPIOB      
   ...
   //  * dma by xls    
    ...
    .o15_icb_cmd_valid  (dma_cfg_icb_cmd_valid),
    .o15_icb_cmd_ready  (dma_cfg_icb_cmd_ready),
    .o15_icb_cmd_addr   (dma_cfg_icb_cmd_addr),
    .o15_icb_cmd_read   (dma_cfg_icb_cmd_read),
    .o15_icb_cmd_wdata  (dma_cfg_icb_cmd_wdata),
    .o15_icb_cmd_wmask  (dma_cfg_icb_cmd_wmask),
    .o15_icb_cmd_lock   (),
    .o15_icb_cmd_excl   (),
    .o15_icb_cmd_size   (),
    .o15_icb_cmd_burst  (),
    ...
    .o15_icb_rsp_valid  (dma_cfg_icb_rsp_valid),
    .o15_icb_rsp_ready  (dma_cfg_icb_rsp_ready),
    .o15_icb_rsp_err    (dma_cfg_icb_rsp_err),
    .o15_icb_rsp_excl_ok(1'b0),
    .o15_icb_rsp_rdata  (dma_cfg_icb_rsp_rdata),
